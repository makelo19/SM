        ...
        if ($fComIdentificador) {
            ...
            if (!empty($allIdentificacoes['data'])) {
                foreach ($allIdentificacoes['data'] as $i) {
                    if (!empty($i[$IDENT_ID_FIELD])) {
                        $identIdsMap[$i[$IDENT_ID_FIELD]] = true;
                    }
                }
            }
            $filters['callback'] = function($row) use ($originalCallback, $identIdsMap, $ID_FIELD_KEY) {
                ...
                $pId = $row[$ID_FIELD_KEY] ?? '';
                if (!$pId) return false;
                return isset($identIdsMap[$pId]);
            };
        }
            ...
            <form onsubmit="filterDashboard(event)" class="row g-3" id="form_dashboard_filter">
                ...
                <div class="col-md-2 d-flex align-items-end">
                    <div class="form-check mb-1">
                        <input class="form-check-input" type="checkbox" value="1" id="fComIdentificador" name="fComIdentificador" <?= !empty($fComIdentificador) ? 'checked' : '' ?>>
