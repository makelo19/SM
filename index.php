...
if (isset($_GET['acao']) && $_GET['acao'] == 'exportar_excel') {
    ...
    // Headers
    $emailHeaders = ['Data e Hora', 'Responsável', 'Assunto', 'Para', 'CC'];
    echo "  <Row>\n";
    ...
    function renderEmailHistory(history) {
        ...
        history.forEach(function(h) {
            if (h.TYPE === 'EMAIL') {
                ...
                tr.innerHTML = '<td><input type="checkbox" name="email_hist_del[]" class="form-check-input" value="'+idVal+'">' + editBtn + '</td>' + 
